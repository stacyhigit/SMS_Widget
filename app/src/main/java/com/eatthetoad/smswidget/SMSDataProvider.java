...
//            initTestData();
    ...
    public RemoteViews getViewAt(int position) {
        ...
        try {
            ...
            fillIntent.putExtra(SMSWidget.EXTRA_ITEM_POSITION, position);
            fillIntent.putExtra(SMSWidget.EXTRA_ITEM_NUMBERS, message.getRecipientNumbers());
            fillIntent.putExtra(SMSWidget.EXTRA_ITEM_ID, message.getId());
